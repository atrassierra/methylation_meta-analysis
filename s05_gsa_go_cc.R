...
## estudiadas. Utilizamos los términos GO referentes a componentes celulares.          ##
...
anot <- annot[["cc"]] # Componentes celulares
length(anot)
...
for (i in 1:length(ficheros)){
  ...
  res[1:3,]
  save (list = "res", file = file.path (.job$dir, "results", "gsea", paste("go_cc_", ficheros[i], sep = "")))
}
