#########################################################################################
##                                                                                     ##
## s06_functional_meta_analysis_go_mf.r                                                ##
...
for (i in methods){
  ...
  if (file.exists(file.path (.job$dir, "meta", "go", "mf", "files"))){
    setwd(file.path(.job$dir, "meta", "go", "mf", "files"))
  } else {
    dir.create(file.path(.job$dir, "meta", "go", "mf", "files"), recursive = T)
    setwd(file.path(.job$dir, "meta", "go", "mf", "files"))    
  }
...
if (file.exists(file.path (.job$dir, "meta", "go", "mf", "plots"))){
  setwd(file.path(.job$dir, "meta", "go", "mf", "plots"))
} else {
  dir.create(file.path(.job$dir, "meta", "go", "mf", "plots"), recursive = T)
  setwd(file.path(.job$dir, "meta", "go", "mf", "plots"))    
}
