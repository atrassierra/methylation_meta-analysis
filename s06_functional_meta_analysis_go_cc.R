#########################################################################################
##                                                                                     ##
## s06_functional_meta_analysis_go_cc.r                                                ##
...
for (i in methods){
  ...
  if (file.exists(file.path (.job$dir, "meta", "go", "cc", "files"))){
    setwd(file.path(.job$dir, "meta", "go", "cc", "files"))
  } else {
    dir.create(file.path(.job$dir, "meta", "go", "cc", "files"), recursive = T)
    setwd(file.path(.job$dir, "meta", "go", "cc", "files"))    
  }
...
if (file.exists(file.path (.job$dir, "meta", "go", "cc", "plots"))){
  setwd(file.path(.job$dir, "meta", "go", "cc", "plots"))
} else {
  dir.create(file.path(.job$dir, "meta", "go", "cc", "plots"), recursive = T)
  setwd(file.path(.job$dir, "meta", "go", "cc", "plots"))    
}
