...
data <- readGEORawFile("tablebrc_norm.txt", sep = "\t", Uname = "Signal_A", Mname = "Signal_B", row.names = 1, array = "IlluminaHumanMethylation450k")
...
save(dmrs, file = "dmrs59901brc.RData")
