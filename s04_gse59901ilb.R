...
write.table(x = datasorted, file = "dmrgen59901ilb.txt", row.names = FALSE, sep = "\t")
...
write.table(x = final, file = "genes59901ilbprom.txt", row.names = FALSE, sep = "\t", quote = FALSE) # Input con el promedio para GSA
save(final, file = "genes59901ilbprom.RData")
...
write.table(x = final, file = "genes59901ilb.txt", sep = "\t", row.names = FALSE, quote = FALSE) # Guardamos input para gsea con el valor absoluto
save(final, file = "genes59901ilb.RData")
