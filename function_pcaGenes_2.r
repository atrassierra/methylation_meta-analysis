#########################################################################################
##                                                                                     ##
## function_pcaGenes_2.r                                                               ##
## Este script consiste en una función para hacer los pca de las matrices de           ## 
## intensidad de señal/arrays.                                                         ##
## Autores: David Montaner, Francisco García García                                    ##
##                                                                                     ##
#########################################################################################
...
plot.pca.genes <- function (pcag, addNames = TRUE, col = "black", col.class = NULL, ...) {
  par (mfrow = c(1,2))
  #
