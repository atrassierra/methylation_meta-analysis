...
data <- readGEORawFile("gse52865her2.txt", sep = "\t", Uname = "unmeth", Mname = "\\.meth", row.names = 1, array = "IlluminaHumanMethylation450k")
...
dev.copy(png, 'QCgse52865her2.png')
dev.off()