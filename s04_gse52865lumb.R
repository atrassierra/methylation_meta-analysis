...
write.table(x = datasorted, file = "dmrgen52865lumb.txt", row.names = FALSE, sep = "\t")
...
write.table(x = final, file = "genes52865lumbprom.txt", row.names = FALSE, sep = "\t", quote = FALSE) # Input con el promedio para GSA
save(final, file = "genes52865lumbprom.RData")
...
write.table(x = final, file = "genes52865lumb.txt", sep = "\t", row.names = FALSE, quote = FALSE) # Guardamos input para gsea con valor absoluto
save(final, file = "genes52865lumb.RData")
