...
data <- readGEORawFile("gse52865luma.txt", sep = "\t", Uname = "unmeth", Mname = "\\.meth", row.names = 1, array = "IlluminaHumanMethylation450k")
...
dev.copy(png, 'QCgse52865luma.png')
dev.off()